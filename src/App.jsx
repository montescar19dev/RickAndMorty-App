...
function App() {
  ...
  const noteText = "This application is made so that at each page charge, random information from each world is displayed. If you don't see any information, please refresh the page or enter a number between 1 and 126 of the available worlds in the \"Location ID\" box above.";
